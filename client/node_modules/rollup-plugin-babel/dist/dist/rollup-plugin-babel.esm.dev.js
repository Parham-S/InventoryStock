...
var addBabelPlugin = function addBabelPlugin(options, plugin) {
...
var escapeRegExpCharacters = function escapeRegExpCharacters(str) {
...
function createPreflightCheck() {
  ...
  return function (ctx, options) {
    ...
    if (preflightCheckResults[key] === undefined) {
      ...
      var transformed = (0, babel.transformSync)(inputCode, options);
      var check = transformed.code;

      if (~check.indexOf('class ')) {
        check = (0, babel.transformSync)(inputCode, addBabelPlugin(options, fallbackClassTransform)).code;
      }
  ...
  return {
    pre: function pre(file) {
      ...
      file.set('helperGenerator', function (name) {
        ...
        return cachedHelpers[name] = (0, _helperModuleImports.addNamed)(file.path, name, HELPERS);
      });
    }
  };
}
...
var unpackOptions = function unpackOptions(ref) {
  if (ref === void 0) ref = {};
  var extensions = ref.extensions;
  if (extensions === void 0) extensions = babel.DEFAULT_EXTENSIONS;
  ...
  return function (pluginOptions) {
    ...
    return {
      ...
      load: function load(id) {
        ...
        return (0, babel.buildExternalHelpers)(externalHelpersWhitelist, 'module');
      },
      transform: function transform(code, filename) {
        ...
        var config = (0, babel.loadPartialConfig)(Object.assign({}, babelOptions, {
          filename: filename
        })); // file is ignored
        ...
        return Promise.resolve(!overrides.config ? config.options : overrides.config.call(this, config, {
          ...
          var result = (0, babel.transformSync)(code, transformOptions);
