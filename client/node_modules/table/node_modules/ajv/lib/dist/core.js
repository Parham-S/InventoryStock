...
__createBinding(exports, types_1, "AnyValidateFunction");
...
__createBinding(exports, jtd_schema_1, "JTDSchemaType");
__createBinding(exports, jtd_schema_1, "SomeJTDSchemaType");
__createBinding(exports, jtd_schema_1, "JTDDataType");
...
function requiredOptions(o) {
    ...
    return {
        ...
        code: o.code ? __assign(__assign({}, o.code), { optimize: optimize }) : { optimize: optimize },
...
var Ajv = /** @class */ (function () {
    ...
    Ajv.prototype.addKeyword = function (kwdOrDef, def // deprecated
        ...
        var definition = __assign(__assign({}, def), { type: dataType_1.getJSONTypes(def.type), schemaType: dataType_1.getJSONTypes(def.schemaType) });
...
function addRule(keyword, definition, dataType) {
    ...
    var rule = {
        keyword: keyword,
        definition: __assign(__assign({}, definition), { type: dataType_1.getJSONTypes(definition.type), schemaType: dataType_1.getJSONTypes(definition.schemaType) })
    };
