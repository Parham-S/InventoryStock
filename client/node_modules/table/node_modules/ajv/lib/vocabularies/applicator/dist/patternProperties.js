    ...
    code: function (cxt) {
        ...
        function validateProperties(pat) {
            gen.forIn("key", data, function (key) {
                gen["if"](codegen_1._(templateObject_1 || (templateObject_1 = __makeTemplateObject(["", ".test(", ")"], ["", ".test(", ")"])), code_1.usePattern(cxt, pat), key), function () {
                    ...
                    if (it.opts.unevaluated && props !== true) {
                        gen.assign(codegen_1._(templateObject_2 || (templateObject_2 = __makeTemplateObject(["", "[", "]"], ["", "[", "]"])), props, key), true);
                    }
