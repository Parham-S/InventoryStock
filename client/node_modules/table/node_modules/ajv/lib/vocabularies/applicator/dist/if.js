...
var error = {
    message: function (_a) {
        ...
        return codegen_1.str(templateObject_1 || (templateObject_1 = __makeTemplateObject(["must match \"", "\" schema"], ["must match \"", "\" schema"])), params.ifClause);
    },
    params: function (_a) {
        var params = _a.params;
        return codegen_1._(templateObject_2 || (templateObject_2 = __makeTemplateObject(["{failingKeyword: ", "}"], ["{failingKeyword: ", "}"])), params.ifClause);
    }
};
var def = {
    keyword: "if",
    ...
    code: function (cxt) {
        ...
        function validateClause(keyword, ifClause) {
            return function () {
                ...
                if (ifClause)
                    gen.assign(ifClause, codegen_1._(templateObject_3 || (templateObject_3 = __makeTemplateObject(["", ""], ["", ""])), keyword));
                else
