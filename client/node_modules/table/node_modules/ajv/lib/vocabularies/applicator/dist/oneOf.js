...
var error = {
    ...
    params: function (_a) {
        ...
        return codegen_1._(templateObject_1 || (templateObject_1 = __makeTemplateObject(["{passingSchemas: ", "}"], ["{passingSchemas: ", "}"])), params.passing);
    }
};
var def = {
    keyword: "oneOf",
    ...
    code: function (cxt) {
        ...
        function validateOneOf() {
            schArr.forEach(function (sch, i) {
                ...
                if (i > 0) {
                    gen["if"](codegen_1._(templateObject_2 || (templateObject_2 = __makeTemplateObject(["", " && ", ""], ["", " && ", ""])), schValid, valid))
                        .assign(valid, false)
                        .assign(passing, codegen_1._(templateObject_3 || (templateObject_3 = __makeTemplateObject(["[", ", ", "]"], ["[", ", ", "]"])), passing, i))["else"]();
                }
