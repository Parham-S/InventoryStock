...
var error = {
    message: function (_a) {
        ...
        return codegen_1.str(templateObject_1 || (templateObject_1 = __makeTemplateObject(["must have required property '", "'"], ["must have required property '", "'"])), missingProperty);
    },
    params: function (_a) {
        var missingProperty = _a.params.missingProperty;
        return codegen_1._(templateObject_2 || (templateObject_2 = __makeTemplateObject(["{missingProperty: ", "}"], ["{missingProperty: ", "}"])), missingProperty);
    }
};
var def = {
    keyword: "required",
