    ...
    code: function (cxt) {
        ...
        function loopEnum() {
            ...
            gen.forOf("v", schemaCode, function (v) {
                return gen["if"](codegen_1._(templateObject_2 || (templateObject_2 = __makeTemplateObject(["", "(", ", ", ")"], ["", "(", ", ", ")"])), eql, data, v), function () { return gen.assign(valid, true)["break"](); });
            });
        }
        function equalCode(vSchema, i) {
            var sch = schema[i];
            return typeof sch === "object" && sch !== null
                ? codegen_1._(templateObject_3 || (templateObject_3 = __makeTemplateObject(["", "(", ", ", "[", "])"], ["", "(", ", ", "[", "])"])), eql, data, vSchema, i) : codegen_1._(templateObject_4 || (templateObject_4 = __makeTemplateObject(["", " === ", ""], ["", " === ", ""])), data, sch);
        }
    }
};
exports["default"] = def;
