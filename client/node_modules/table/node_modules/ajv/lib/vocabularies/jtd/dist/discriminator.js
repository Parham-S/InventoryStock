...
var error = {
    ...
    params: function (cxt) {
        var schema = cxt.schema, params = cxt.params;
        return params.discrError
            ? codegen_1._(templateObject_1 || (templateObject_1 = __makeTemplateObject(["{error: ", ", tag: ", ", tagValue: ", "}"], ["{error: ", ", tag: ", ", tagValue: ", "}"])), params.discrError, schema, params.tag) : error_1.typeErrorParams(cxt, "object");
    }
};
var def = {
    ...
    code: function (cxt) {
        ...
        function validateDiscriminator() {
            var tag = gen["const"]("tag", codegen_1._(templateObject_2 || (templateObject_2 = __makeTemplateObject(["", "", ""], ["", "", ""])), data, codegen_1.getProperty(schema)));
            gen["if"](codegen_1._(templateObject_3 || (templateObject_3 = __makeTemplateObject(["", " === undefined"], ["", " === undefined"])), tag));
            cxt.error(false, { discrError: types_1.DiscrError.Tag, tag: tag });
            gen.elseIf(codegen_1._(templateObject_4 || (templateObject_4 = __makeTemplateObject(["typeof ", " == \"string\""], ["typeof ", " == \"string\""])), tag));
            validateMapping(tag);
            gen["else"]();
        ...
        function validateMapping(tag) {
            ...
            for (var tagValue in parentSchema.mapping) {
                gen.elseIf(codegen_1._(templateObject_5 || (templateObject_5 = __makeTemplateObject(["", " === ", ""], ["", " === ", ""])), tag, tagValue));
