...
function dynamicAnchor(cxt, anchor) {
    ...
    var v = codegen_1._(templateObject_1 || (templateObject_1 = __makeTemplateObject(["", "", ""], ["", "", ""])), names_1["default"].dynamicAnchors, codegen_1.getProperty(anchor));
    var validate = it.errSchemaPath === "#" ? it.validateName : _getValidate(cxt);
    gen["if"](codegen_1._(templateObject_2 || (templateObject_2 = __makeTemplateObject(["!", ""], ["!", ""])), v), function () { return gen.assign(v, validate); });
}
