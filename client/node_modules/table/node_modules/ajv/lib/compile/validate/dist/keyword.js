...
function funcKeywordCode(cxt, def) {
    ...
    function validateAsync() {
        ...
        gen["try"](function () { return assignValid(codegen_1._(templateObject_1 || (templateObject_1 = __makeTemplateObject(["await "], ["await "])))); }, function (e) {
            return gen.assign(valid, false)["if"](codegen_1._(templateObject_2 || (templateObject_2 = __makeTemplateObject(["", " instanceof ", ""], ["", " instanceof ", ""])), e, it.ValidationError), function () { return gen.assign(ruleErrs, codegen_1._(templateObject_3 || (templateObject_3 = __makeTemplateObject(["", ".errors"], ["", ".errors"])), e)); }, function () { return gen["throw"](e); });
        });
        return ruleErrs;
    }
    function validateSync() {
        var validateErrs = codegen_1._(templateObject_4 || (templateObject_4 = __makeTemplateObject(["", ".errors"], ["", ".errors"])), validateRef);
        gen.assign(validateErrs, null);
        assignValid(codegen_1.nil);
        return validateErrs;
    }
    function assignValid(_await) {
        if (_await === void 0) { _await = def.async ? codegen_1._(templateObject_5 || (templateObject_5 = __makeTemplateObject(["await "], ["await "]))) : codegen_1.nil; }
        ...
        gen.assign(valid, codegen_1._(templateObject_6 || (templateObject_6 = __makeTemplateObject(["", "", ""], ["", "", ""])), _await, code_1.callValidateCode(cxt, validateRef, passCxt, passSchema)), def.modifying);
    }
...
function modifyData(cxt) {
    ...
    gen["if"](it.parentData, function () { return gen.assign(data, codegen_1._(templateObject_7 || (templateObject_7 = __makeTemplateObject(["", "[", "]"], ["", "[", "]"])), it.parentData, it.parentDataProperty)); });
}
function addErrs(cxt, errs) {
    var gen = cxt.gen;
    gen["if"](codegen_1._(templateObject_8 || (templateObject_8 = __makeTemplateObject(["Array.isArray(", ")"], ["Array.isArray(", ")"])), errs), function () {
        gen
            .assign(names_1["default"].vErrors, codegen_1._(templateObject_9 || (templateObject_9 = __makeTemplateObject(["", " === null ? ", " : ", ".concat(", ")"], ["", " === null ? ", " : ", ".concat(", ")"])), names_1["default"].vErrors, errs, names_1["default"].vErrors, errs))
            .assign(names_1["default"].errors, codegen_1._(templateObject_10 || (templateObject_10 = __makeTemplateObject(["", ".length"], ["", ".length"])), names_1["default"].vErrors));
...
function validateKeywordUsage(_a, def, keyword) {
    ...
    if (def.validateSchema) {
        ...
        if (!valid) {
            var msg = "keyword \"" + keyword + "\" value is invalid at path \"" + errSchemaPath + "\": " +
