...
function addMetaSchema2020($data) {
  ...
  ;
  [metaSchema, applicator, unevaluated, content, core, with$data(this, format), metadata, with$data(this, validation)].forEach(function (sch) {
    return _this.addMetaSchema(sch, undefined, false);
  });
  return this;
