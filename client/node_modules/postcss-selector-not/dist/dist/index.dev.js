...
function explodeSelector(pseudoClass, selector) {
  ...
  if (selector && position > -1) {
    ...
    return "".concat(pre).concat(pseudoClass, "(").concat(bodySelectors, ")").concat(postSelectors);
  }
...
function locatePseudoClass(selector, pseudoClass) {
  patternCache[pseudoClass] = patternCache[pseudoClass] || new RegExp("([^\\\\]|^)".concat(pseudoClass)); // The regex is used to ensure that selectors with
