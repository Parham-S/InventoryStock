...
function (_Prompt) {
  ...
  function Sort(options) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(Sort).call(this, _objectSpread({}, options, {
      reorder: false,
      sort: true,
      multiple: true
    })));
  ...
  _createClass(Sort, [{
    ...
    value: function renderChoice(choice, i) {
      var str, sym, pre;
      return regeneratorRuntime.async(function renderChoice$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return regeneratorRuntime.awrap(_get(_getPrototypeOf(Sort.prototype), "renderChoice", this).call(this, choice, i));
