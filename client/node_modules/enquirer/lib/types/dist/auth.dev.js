...
var factory = function factory() {
  ...
  var AuthPrompt =
  /*#__PURE__*/
  function (_FormPrompt) {
    _inherits(AuthPrompt, _FormPrompt);

    function AuthPrompt(options) {
      _classCallCheck(this, AuthPrompt);

      return _possibleConstructorReturn(this, _getPrototypeOf(AuthPrompt).call(this, options));
    }
        ...
        return regeneratorRuntime.async(function submit$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return regeneratorRuntime.awrap(authenticate.call(this, this.values, this.state));
