...
exports.getFCP = function (onReport, reportAllChanges) {
    var firstHidden = getFirstHidden_js_1.getFirstHidden();
    var metric = initMetric_js_1.initMetric('FCP');
    var report;
    ...
    var po = observe_js_1.observe('paint', entryHandler);
    if (po) {
        ...
        onBFCacheRestore_js_1.onBFCacheRestore(function (event) {
            metric = initMetric_js_1.initMetric('FCP');
            report = bindReporter_js_1.bindReporter(onReport, metric, reportAllChanges);
