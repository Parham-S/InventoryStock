...
var cloneRule = function cloneRule(decl, dir) {
...
var transformFloat = function transformFloat(decl, values, dir) {
...
var transformInset = function transformInset(decl, values, dir) {
  if ('logical' !== values[0]) {
    return [decl.clone({
      prop: 'top',
      value: values[0]
...
var transformResize = function transformResize(decl) {
...
var cloneDecl = function cloneDecl(decl, suffix, value) {
  return decl.clone({
...
var transformTextAlign = function transformTextAlign(decl, values, dir) {
  var lDecl = decl.clone({
    value: 'left'
  });
  var rDecl = decl.clone({
...
var transformTransition = function transformTransition(decl, notValues, dir) {
  var ltrValues = [];
  var rtlValues = [];
