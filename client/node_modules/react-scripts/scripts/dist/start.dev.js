...
if (process.env.HOST) {
  ...
  console.log("Learn more here: ".concat(chalk.yellow('https://cra.link/advanced-config')));
  console.log();
...
checkBrowsers(paths.appPath, isInteractive).then(function () {
  ...
  var urls = prepareUrls(protocol, HOST, port, paths.publicUrlOrPath.slice(0, -1));
  var devSocket = {
  ...
  var proxyConfig = prepareProxy(proxySetting, paths.appPublic, paths.publicUrlOrPath); // Serve webpack assets generated by the compiler over a web server.
  ...
  devServer.listen(port, HOST, function (err) {
    ...
    if (env.raw.FAST_REFRESH && semver.lt(react.version, '16.10.0')) {
      console.log(chalk.yellow("Fast Refresh requires React 16.10 or higher. You are using React ".concat(react.version, ".")));
    }
