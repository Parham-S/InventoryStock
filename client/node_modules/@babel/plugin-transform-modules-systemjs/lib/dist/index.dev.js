...
var MISSING_PLUGIN_ERROR = "ERROR: Dynamic import() transformation must be enabled using the\n       @babel/plugin-proposal-dynamic-import plugin. Babel 8\n       no longer transforms import() without using that plugin.\n";
        ...
        exit: function exit(path, state) {
          ...
          modules.forEach(function (specifiers) {
            ...
            if (specifiers.exports.length) {
              ...
              setterBody.push.apply(setterBody, _toConsumableArray(constructExportCall(path, _core.types.identifier(exportIdent), _exportNames, _exportValues, hasExportStar ? _core.types.identifier(target) : null, stringSpecifiers)));
            }
          ...
          if (exportNames.length) {
            beforeBody.push.apply(beforeBody, _toConsumableArray(constructExportCall(path, _core.types.identifier(exportIdent), exportNames, exportValues, null, stringSpecifiers)));
          }
