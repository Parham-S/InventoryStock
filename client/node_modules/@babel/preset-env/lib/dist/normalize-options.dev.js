...
var v = new _helperValidatorOption.OptionValidator("@babel/preset-env");
...
var getValidIncludesAndExcludes = function getValidIncludesAndExcludes(type, corejs) {
  return new Set([].concat(_toConsumableArray(allPluginsList), _toConsumableArray(type === "exclude" ? modulePlugins : []), _toConsumableArray(corejs ? corejs == 2 ? [].concat(_toConsumableArray(Object.keys(_corejs2BuiltIns)), corejs2DefaultWebIncludes) : Object.keys(_data) : [])));
};
