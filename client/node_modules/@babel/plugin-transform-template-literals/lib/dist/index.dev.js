  ...
  return {
    ...
    visitor: {
      TaggedTemplateExpression: function TaggedTemplateExpression(path) {
        ...
        var helperArgs = [_core.types.arrayExpression(strings)];
        ...
        path.replaceWith(_core.types.callExpression(node.tag, [_core.template.expression.ast(_templateObject(), _core.types.cloneNode(tmp), tmp, this.addHelper(helperName), helperArgs)].concat(_toConsumableArray(quasi.expressions))));
      },
