...
function transform(path, _ref) {
  ...
  for (var i = optionals.length - 1; i >= 0; i--) {
    ...
    if (willReplacementCastToBoolean) {
      var nonNullishCheck = noDocumentAll ? ast(_templateObject2(), core.types.cloneNode(check)) : ast(_templateObject3(), core.types.cloneNode(check), core.types.cloneNode(ref));
      ...
      var nullishCheck = noDocumentAll ? ast(_templateObject4(), core.types.cloneNode(check)) : ast(_templateObject5(), core.types.cloneNode(check), core.types.cloneNode(ref));
