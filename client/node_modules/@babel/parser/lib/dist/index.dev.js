      ...
      _createClass(_class4, [{
        ...
        value: function parseClassMember(classBody, member, state) {
          ...
          var callParseClassMemberWithIsStatic = function callParseClassMemberWithIsStatic() {
            if (_this40.tsIsStartOfStaticBlocks()) {
              _this40.next();

              _this40.next();

              if (_this40.tsHasSomeModifiers(member, modifiers)) {
                _this40.raise(_this40.state.pos, TSErrors.StaticBlockCannotHaveModifier);
              }

              _this40.parseClassStaticBlock(classBody, member);
            } else {
              _this40.parseClassMemberWithIsStatic(classBody, member, state, !!member["static"]);
            }
          };
          ...
          switch (this.getPluginOption("pipelineOperator", "proposal")) {
            case "hack":
              return this.withTopicBindingContext(function () {
                return _this50.parseHackPipeBody();
              });

            case "smart":
              return this.withTopicBindingContext(function () {
                if (_this50.prodParam.hasYield && _this50.isContextual("yield")) {
                  throw _this50.raise(_this50.state.start, ErrorMessages.PipeBodyIsTighter, _this50.state.value);
                }

                return _this50.parseSmartPipelineBodyInStyle(_this50.parseExprOpBaseRightExpr(op, prec), startPos, startLoc);
              });
