...
var _default = (0, _helperPluginUtils.declare)(function (api, opts) {
  ...
  var supportsObjectAssign = !(0, _helperCompilationTargets.isRequired)("es6.object.assign", targets, {
  ...
  function createObjectRest(path, file, objRef) {
    ...
    return [impureComputedPropertyDeclarators, restElement.argument, _core.types.callExpression(file.addHelper("objectWithoutProperties".concat(objectRestNoSymbols ? "Loose" : "")), [_core.types.cloneNode(objRef), keyExpression])];
  }
    ...
    visitor: {
      ...
      AssignmentExpression: function AssignmentExpression(path, file) {
        ...
        if (leftPath.isObjectPattern() && hasRestElement(leftPath)) {
          ...
          var _createObjectRest3 = createObjectRest(leftPath, file, _core.types.identifier(refName)),
