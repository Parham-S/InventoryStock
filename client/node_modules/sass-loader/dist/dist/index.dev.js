        ...
        case 10:
          ...
          render(sassOptions, function (error, result) {
            ...
            result.stats.includedFiles.forEach(function (includedFile) {
              var normalizedIncludedFile = _path["default"].normalize(includedFile); // Custom `importer` can return only `contents` so includedFile will be relative


              if (_path["default"].isAbsolute(normalizedIncludedFile)) {
                _this.addDependency(normalizedIncludedFile);
              }
            });
