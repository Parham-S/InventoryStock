...
function getSassImplementation(loaderContext, implementation) {
  ...
  if (implementationName === "dart-sass") {
    ...
    if (!_semver["default"].satisfies(version, "^4.0.0 || ^5.0.0 || ^6.0.0")) {
      loaderContext.emitError(new Error("Node Sass version ".concat(version, " is incompatible with ^4.0.0 || ^5.0.0 || ^6.0.0.")));
    } // eslint-disable-next-line consistent-return
      ...
      switch (_context.prev = _context.next) {
        ...
        case 16:
          ...
          (options.includePaths || []).map(function (includePath) {
            return _path["default"].isAbsolute(includePath) ? includePath : _path["default"].join(process.cwd(), includePath);
