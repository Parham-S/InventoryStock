...
(function (global, factory) {
  (typeof exports === "undefined" ? "undefined" : _typeof(exports)) === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('react-dom')) : typeof define === 'function' && define.amd ? define(['exports', 'react', 'react-dom'], factory) : (global = global || self, factory(global.ReactTestUtils = {}, global.React, global.ReactDOM));
})(void 0, function (exports, React, ReactDOM) {
  'use strict';
  ...
  function unstable_concurrentAct(scope) {
    ...
    try {
      ...
      if (_typeof(thenable) === 'object' && thenable !== null && typeof thenable.then === 'function') {
        return {
          then: function then(resolve, reject) {
