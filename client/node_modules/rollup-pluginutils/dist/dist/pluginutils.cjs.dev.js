...
function getMatcherString(id, resolutionBase) {
  ...
  return path.resolve.apply(path, _toConsumableArray(typeof resolutionBase === 'string' ? [resolutionBase, id] : [id]));
}
...
var createFilter = function createFilter(include, exclude, options) {
  ...
  var getMatcher = function getMatcher(id) {
    return id instanceof RegExp ? id : {
      test: micromatch_1.matcher(getMatcherString(id, resolutionBase).split(path.sep).join('/'), {
        dot: true
      })
    };
  };
