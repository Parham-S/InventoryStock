...
function getPublicUrlOrPath(isEnvDevelopment, homepage, envPublicUrl) {
  var stubDomain = 'https://create-react-app.dev';
  ...
  if (envPublicUrl) {
    ...
    var validPublicUrl = new URL(envPublicUrl, stubDomain);
  ...
  if (homepage) {
    ...
    var validHomepagePathname = new URL(homepage, stubDomain).pathname;
