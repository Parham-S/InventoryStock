...
var _require = require("./shared/deprecation-warnings"),
...
var debug = require("debug")("eslintrc:cascading-config-array-factory"); //------------------------------------------------------------------------------
// Helpers
//------------------------------------------------------------------------------
...
function () {
  ...
  function CascadingConfigArrayFactory() {
    var _ref3 = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
        ...
        resolvePluginsRelativeTo = _ref3.resolvePluginsRelativeTo,
        ...
        _ref3$builtInRules = _ref3.builtInRules,
        builtInRules = _ref3$builtInRules === void 0 ? new Map() : _ref3$builtInRules,
        loadRules = _ref3.loadRules,
        resolver = _ref3.resolver,
        eslintRecommendedPath = _ref3.eslintRecommendedPath,
        eslintAllPath = _ref3.eslintAllPath;
    ...
    value: function _loadConfigInAncestors(directoryPath) {
      ...
      if (directoryPath === homePath && cwd !== homePath) {
        ...
        if (configsExistInSubdirs) {
          var filePath = ConfigArrayFactory.getPathToConfigFileInDirectory(directoryPath);
