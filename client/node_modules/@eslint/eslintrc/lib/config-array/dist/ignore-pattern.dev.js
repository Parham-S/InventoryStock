...
var debug = require("debug")("eslintrc:ignore-pattern");
...
function getCommonAncestorPath(sourcePaths) {
  ...
  var resolvedResult = result || path.sep; // if Windows common ancestor is root of drive must have trailing slash to be absolute.
