...
var PluginConflictError =
/*#__PURE__*/
function (_Error) {
  _inherits(PluginConflictError, _Error);
  ...
  function PluginConflictError(pluginId, plugins) {
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(PluginConflictError).call(this, "Plugin \"".concat(pluginId, "\" was conflicted between ").concat(plugins.map(function (p) {
