...
function () {
  _createClass(OverrideTester, null, [{
    ...
    value: function create(files, excludedFiles, basePath) {
      ...
      try {
        for (var _iterator = includePatterns[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      try {
        for (var _iterator2 = excludePatterns[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          var _pattern = _step2.value;

          if (path.isAbsolute(_pattern) || _pattern.includes("..")) {
