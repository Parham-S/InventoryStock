...
var validTargets = new Set(['android', 'chrome', 'deno', 'edge', 'electron', 'firefox', 'ie', 'ios', 'node', 'opera', 'opera_mobile', 'phantom', 'rhino', 'safari', 'samsung']);
...
module.exports = function (targets) {
  ...
  if (browsers) {
    if (typeof browsers === 'string' || Array.isArray(browsers)) {
      ...
      list.push.apply(list, _toConsumableArray(Object.entries(browsers)));
    }
  }
