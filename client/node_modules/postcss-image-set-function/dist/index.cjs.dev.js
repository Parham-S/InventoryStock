...
var getMedia = function getMedia(node, mediasByDpr) {
...
var handleInvalidation = function handleInvalidation(opts, message, word) {
...
var processImageSet = function processImageSet(imageSetOptionNodes, decl, opts) {
  ...
  return function (root, result) {
    ...
    root.walkDecls(function (decl) {
      ...
      if (imageSetValueMatchRegExp.test(value)) {
        var valueAST = valueParser(value).parse(); // process every image-set() function
