...
exports.BroadcastUpdatePlugin = void 0;
var dontWaitFor_js_1 = require("workbox-core/_private/dontWaitFor.js");
var BroadcastCacheUpdate_js_1 = require("./BroadcastCacheUpdate.js");
require("./_version.js");
/**
 ...
 */
var BroadcastUpdatePlugin = /** @class */ (function () {
    /**
     ...
     */
    function BroadcastUpdatePlugin(options) {
        var _this = this;
        /**
         ...
         */
        this.cacheDidUpdate = function (options) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                dontWaitFor_js_1.dontWaitFor(this._broadcastUpdate.notifyIfUpdated(options));
                return [2 /*return*/];
            });
        }); };
        this._broadcastUpdate = new BroadcastCacheUpdate_js_1.BroadcastCacheUpdate(options);
    }
