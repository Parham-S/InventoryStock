  ...
  return function i(s, a, l) {
    ...
    15: [function (t, e, n) {
      ...
      2 !== "ab".split(/(?:ab)*/).length || 4 !== ".".split(/(.?)(.?)/).length || "t" === "tesst".split(/(s)*/)[1] || 4 !== "test".split(/(?:)/, -1).length || "".split(/.?/).length || 1 < ".".split(/()()/).length ? (_ = void 0 === /()??/.exec("")[1], s.split = function (t, e) {
        ...
        }), 1 < o.length && o.index < n.length && c.push.apply(a, o.slice(1)), s = o[0].length, u = i, a.length >= e));) {
    ...
    17: [function (o, f, t) {
      (function (t) {
        ...
        e(c, i), c.prototype._start = function (t, e, n, r) {
          ...
          if (r && r.noCredentials || !c.supportsCORS || (u("withCredentials"), this.xhr.withCredentials = !0), r && r.headers) for (var i in r.headers) {
        ...
        !c.enabled && n in t && (u("overriding xmlhttprequest"), c.enabled = !!new (l = function l() {
          try {
    ...
    52: [function (t, e, n) {
      ...
      e.exports = {
        ...
        isLoopbackAddr: function isLoopbackAddr(t) {
    ...
    54: [function (t, e, n) {
      "function" == typeof Object.create ? e.exports = function (t, e) {
        ...
        if (e) {
          ...
          t.super_ = e;
          _n.prototype = e.prototype, t.prototype = new _n(), t.prototype.constructor = t;
        }
      };
    }, {}],
    55: [function (t, a, l) {
        ...
        (function () {
          var J = {
            ...
            "object": !0
              ...
              t = J[_typeof(l)] && l && !l.nodeType && l,
              B = J[typeof window === "undefined" ? "undefined" : _typeof(window)] && window || this,
              e = t && J[_typeof(a)] && a && !a.nodeType && "object" == _typeof(s) && s;
          ...
          function F(t, l) {
            ...
            var u = t.Number || B.Number,
                ...
                d = t.Math || B.Math,
                r = t.JSON || B.JSON;
            "object" == _typeof(r) && r && (l.stringify = r.stringify, l.parse = r.parse);
            var y,
                o = e.prototype,
                g = o.toString,
                a = o.hasOwnProperty;
            ...
            if (w(function () {
              ...
              var h = "[object Function]",
                ...
                return n = s = null, (_j = o ? function (t, e) {
                  var n,
                      r,
                      o = g.call(t) == h;
                  ...
                  var n,
                      r,
                      o = g.call(t) == h,
                      i = !o && "function" != typeof t.constructor && J[_typeof(t.hasOwnProperty)] && t.hasOwnProperty || a;
              ...
              if (!f("json-stringify") && !f("date-serialization")) {
                ...
                var i = {
                  ...
                  if (p) e = function e(t) {
                    ...
                    e = function e(t) {
                      for (o = f(t / 864e5), n = f(o / 365.2425) + 1970 - 1; _c(n + 1, 0) <= o; n++) {
                        ;
                      }

                      for (r = f((o - _c(n, 0)) / 30.42); _c(n, r + 1) <= o; r++) {
                        ;
                      }

                      o = 1 + o - _c(n, r), s = f((i = (t % 864e5 + 864e5) % 864e5) / 36e5) % 24, a = f(i / 6e4) % 60, l = f(i / 1e3) % 60, u = i % 1e3;
                    };
                  }
                  return (_T = function T(t) {
                ...
                if (f("json-stringify") && !f("date-serialization")) {
                  ...
                  var N = /[\x00-\x1f\x22\x5c]/g,
                      k = function k(t, e, n, r, o, i, s) {
                    var a, l, u, c, f, h, d, p, m;
                    if (w(function () {
                      a = e[t];
                    }), "object" == _typeof(a) && a && (a.getUTCFullYear && "[object Date]" == g.call(a) && a.toJSON === v.prototype.toJSON ? a = _T(a) : "function" == typeof a.toJSON && (a = a.toJSON(t))), n && (a = n.call(e, t, a)), a == y) return a === y ? a : "null";

                    switch ("object" == (l = _typeof(a)) && (u = g.call(a)), u || l) {
                      case "boolean":
                      case "[object Boolean]":
                        return "" + a;
                    ...
                    if ("object" == _typeof(a)) {
                      ...
                      if (s.push(a), c = [], p = i, i += o, u == E) {
                        for (h = 0, d = a.length; h < d; h++) {
                          f = k(h, a, n, r, o, i, s), c.push(f === y ? "null" : f);
                        }

                        m = c.length ? o ? "[\n" + i + c.join(",\n" + i) + "\n" + p + "]" : "[" + c.join(",") + "]" : "[]";
                      } else _j(r || a, function (t) {
                  ...
                  l.stringify = function (t, e, n) {
                    var r, o, i, s;
                    if (J[_typeof(e)] && e) if ((s = g.call(e)) == h) o = e;else if (s == E) {
                      i = {};

                      for (var a, l = 0, u = e.length; l < u;) {
                        a = e[l++], "[object String]" != (s = g.call(a)) && "[object Number]" != s || (i[a] = 1);
                      }
                    }
                    if (n) if ((s = g.call(n)) == x) {
                      if (0 < (n -= n % 1)) for (10 < n && (n = 10), r = ""; r.length < n;) {
                        r += " ";
                      }
              ...
              if (!f("json-parse")) {
                ...
                var L = function L() {
                  for (var t, e, n, r, o, i = U, s = i.length; R < s;) {
                    switch (o = i.charCodeAt(R)) {
                      ...
                      case 34:
                        for (t = "@", R++; R < s;) {
                          if ((o = i.charCodeAt(R)) < 32) I();else if (92 == o) switch (o = i.charCodeAt(++R)) {
                            case 92:
                            case 34:
                            case 47:
                            case 98:
                            ...
                            for (o = i.charCodeAt(R), e = R; 32 <= o && 92 != o && 34 != o;) {
                              o = i.charCodeAt(++R);
                            }
                ...
                var R,
                  ...
                  if ("$" == t && I(), "string" == typeof t) {
                    ...
                    if ("[" == t) {
                      for (e = []; "]" != (t = L());) {
                        n ? "," == t ? "]" == (t = L()) && I() : I() : n = !0, "," == t && I(), e.push(D(t));
                      }
                    ...
                    if ("{" == t) {
                      for (e = {}; "}" != (t = L());) {
                        n ? "," == t ? "}" == (t = L()) && I() : I() : n = !0, "," != t && "string" == typeof t && "@" == (m ? t.charAt(0) : t[0]) && ":" == L() || I(), e[t.slice(1)] = D(L());
                      }
                  ...
                  var r,
                      o = t[e];
                  if ("object" == _typeof(o) && o) if (g.call(o) == E) for (r = o.length; r--;) {
                    P(g, _j, o);
                  } else _j(o, function (t) {
                    P(o, t, n);
                  });
                  return n.call(t, e, o);
                };
    ...
    58: [function (t, n, e) {
      (function (i) {
        ...
        function y(t) {
          ...
          if ("blob:" === t.protocol) r = new x(unescape(t.pathname), {});else if ("string" == o) for (e in r = new x(t, {}), a) {
            delete r[e];
          } else if ("object" == o) {
            for (e in t) {
              e in a || (r[e] = t[e]);
        ...
        function x(t, e, n) {
          ...
          for ("object" != c && "string" != c && (n = e, e = null), n && "function" != typeof n && (n = p.parse), r = !(o = w(t || "", e = y(e))).protocol && !o.slashes, f.slashes = o.slashes || r && e.slashes, f.protocol = o.protocol || e.protocol || "", t = o.rest, ("file:" === o.protocol && (2 !== o.slashesCount || m.test(t)) || !o.slashes && (o.protocol || o.slashesCount < 2 || !g(f.protocol))) && (u[3] = [/(.*)/, "pathname"]); h < u.length; h++) {
            "function" != typeof (s = u[h]) ? (i = s[0], l = s[1], i != i ? f[l] = t : "string" == typeof i ? ~(a = t.indexOf(i)) && (t = "number" == typeof s[2] ? (f[l] = t.slice(0, a), t.slice(a + s[2])) : (f[l] = t.slice(a), t.slice(0, a))) : (a = i.exec(t)) && (f[l] = a[1], t = t.slice(0, a.index)), f[l] = f[l] || r && s[3] && e[l] || "", s[4] && (f[l] = f[l].toLowerCase())) : t = s(t, f);
          }
