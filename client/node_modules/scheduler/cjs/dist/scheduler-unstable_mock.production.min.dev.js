...
function z(a, b) {
  ...
  a: for (;;) {
    var d = c - 1 >>> 1,
        e = a[d];
    if (void 0 !== e && 0 < A(e, b)) a[d] = b, a[c] = e, c = d;else break a;
  }
}
    ...
    if (c !== b) {
      ...
      a: for (var d = 0, e = a.length; d < e;) {
        var u = 2 * (d + 1) - 1,
            ...
            w = u + 1,
            y = a[w];
        if (void 0 !== v && 0 > A(v, c)) void 0 !== y && 0 > A(y, v) ? (a[d] = y, a[w] = c, d = w) : (a[d] = v, a[u] = c, d = u);else if (void 0 !== y && 0 > A(y, c)) a[d] = y, a[w] = c, d = w;else break a;
      }
    }
...
exports.unstable_advanceTime = function (a) {
  "disabledLog" !== console.log.name && (f += a, null !== h && k <= f && (h(f), k = -1, h = null));
};
...
exports.unstable_scheduleCallback = function (a, b, c) {
  ...
  c > d ? (a.sortIndex = c, z(E, a), null === B(D) && a === B(E) && (K ? (h = null, k = -1) : K = !0, h = M, k = f + (c - d))) : (a.sortIndex = e, z(D, a), J || I || (J = !0, g = N));
  return a;
};
...
exports.unstable_yieldValue = function (a) {
  "disabledLog" !== console.log.name && (null === l ? l = [a] : l.push(a));
};