...
function childTextContentExcludingDescendantsOfScript(root) {
  ...
  try {
    for (var _iterator2 = domSymbolTree.childrenIterator(root)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
