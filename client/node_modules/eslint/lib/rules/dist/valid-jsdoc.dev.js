      ...
      if (jsdocNode) {
        ...
        if (node.params) {
          node.params.forEach(function (param, paramsIndex) {
            var bindingParam = param.type === "AssignmentPattern" ? param.left : param; // TODO(nzakas): Figure out logical things to do with destructured, default, rest params

            if (bindingParam.type === "Identifier") {
              var name = bindingParam.name;
        ...
        if (options.matchDescription) {
          var regex = new RegExp(options.matchDescription, "u");
