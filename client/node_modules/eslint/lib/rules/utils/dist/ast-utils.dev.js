...
var _require = require("../../shared/ast-utils"),
    breakableTypePattern = _require.breakableTypePattern,
    createGlobalLinebreakMatcher = _require.createGlobalLinebreakMatcher,
    lineBreakPattern = _require.lineBreakPattern,
    shebangPattern = _require.shebangPattern; //------------------------------------------------------------------------------
// Helpers
//------------------------------------------------------------------------------
...
var thisTagPattern = /^[\t-\r \*\xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*@this/m;
var COMMENTS_IGNORE_PATTERN = /^[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*(?:eslint|jshint[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]+|jslint[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]+|istanbul[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]+|globals?[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]+|exported[\t-\r \xA0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]+|jscs)/;
var LINEBREAKS = new Set(["\r\n", "\r", "\n", "\u2028", "\u2029"]); // A set of node types that can contain a list of statements

var STATEMENT_LIST_PARENTS = new Set(["Program", "BlockStatement", "SwitchCase"]);
var DECIMAL_INTEGER_PATTERN = /^(?:0|0[0-7]*[89][0-9]*|[1-9](?:_?[0-9])*)$/; // Tests the presence of at least one LegacyOctalEscapeSequence or NonOctalDecimalEscapeSequence in a raw string

var OCTAL_OR_NON_OCTAL_DECIMAL_ESCAPE_PATTERN = /^(?:(?:[\0-\[\]-\uD7FF\uE000-\uFFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF])|\\(?:[\0-\uD7FF\uE000-\uFFFF]|[\uD800-\uDBFF][\uDC00-\uDFFF]|[\uD800-\uDBFF](?![\uDC00-\uDFFF])|(?:[^\uD800-\uDBFF]|^)[\uDC00-\uDFFF]))*\\(?:[1-9]|0[0-9])/;
...
function isSpecificMemberAccess(node, objectName, propertyName) {
  var checkNode = skipChainExpression(node);
  ...
  if (propertyName) {
    var actualPropertyName = getStaticPropertyName(checkNode);
...
function isSameReference(left, right) {
  var disableStaticComputedKey = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
    ...
    case "MemberExpression":
      {
        if (!disableStaticComputedKey) {
          var nameA = getStaticPropertyName(left); // x.y = x["y"]
...
module.exports = {
  ...
  isDefaultThisBinding: function isDefaultThisBinding(node, sourceCode) {
    var _ref = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {},
        _ref$capIsConstructor = _ref.capIsConstructor,
        capIsConstructor = _ref$capIsConstructor === void 0 ? true : _ref$capIsConstructor;
      ...
      switch (parent.type) {
        ...
        case "MemberExpression":
          if (parent.object === currentNode && isSpecificMemberAccess(parent, null, bindOrCallOrApplyPattern)) {
            var maybeCalleeNode = parent.parent.type === "ChainExpression" ? parent.parent : parent;
  ...
  getDirectivePrologue: function getDirectivePrologue(node) {
    var directives = []; // Directive prologues only occur at the top of files or functions.
   ...
   */
  isDecimalIntegerNumericToken: function isDecimalIntegerNumericToken(token) {
  ...
  getFunctionNameWithKind: function getFunctionNameWithKind(node) {
    ...
    if (node.id) {
      ...
      var name = getStaticPropertyName(parent);
   ...
   */
  getNextLocation: function getNextLocation(sourceCode, _ref2) {
    var line = _ref2.line,
        column = _ref2.column;
   ...
   */
  isNumericLiteral: function isNumericLiteral(node) {
  ...
  canTokensBeAdjacent: function canTokensBeAdjacent(leftValue, rightValue) {
    ...
    if (typeof rightValue === "string") {
      ...
      try {
        _tokens = espree.tokenize(rightValue, espreeOptions);
      } catch (_unused2) {
        return false;
      }

      var _comments = _tokens.comments;
      rightToken = _tokens[0];
   ...
   */
  getNameLocationInGlobalDirectiveComment: function getNameLocationInGlobalDirectiveComment(sourceCode, comment, name) {
    var namePattern = new RegExp("[\\s,]".concat(escapeRegExp(name), "(?:$|[\\s,:])"), "gu"); // To ignore the first text "global".

    namePattern.lastIndex = comment.value.indexOf("global") + 6; // Search a given variable name.

    var match = namePattern.exec(comment.value); // Convert the index to loc.
   ...
   */
  hasOctalOrNonOctalDecimalEscapeSequence: function hasOctalOrNonOctalDecimalEscapeSequence(rawString) {
  ...
  isSpecificMemberAccess: isSpecificMemberAccess,
  equalLiteralValue: equalLiteralValue,
  isSameReference: isSameReference,
  isLogicalAssignmentOperator: isLogicalAssignmentOperator
};